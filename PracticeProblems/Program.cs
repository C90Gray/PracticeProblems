...
namespace PracticeProblems
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //create array length 25. 
            //populate that array with a for loop
            //create for loop
            //pring to the console every other element

            int[] luckyNumbers = new int[25];
            ...
            Console.WriteLine("");
            Console.WriteLine("Stay away from these numbers");

            for(int i = 0; i < luckyNumbers.Length; i+=2)
            {
                Console.WriteLine(luckyNumbers[i]);
            }
